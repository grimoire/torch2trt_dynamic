...
@tensorrt_converter('torch2trt.converters.size.ShapeWarper.numel')
...
@tensorrt_converter("torch2trt.converters.size.IntWarper.__add__")
...
@tensorrt_converter("torch2trt.converters.size.IntWarper.__radd__")
def convert_intwarper_radd(ctx):
    convert_intwarper_add(ctx)

    
@tensorrt_converter("torch2trt.converters.size.IntWarper.__mul__")
...
@tensorrt_converter("torch2trt.converters.size.IntWarper.__rmul__")
def convert_intwarper_rmul(ctx):
    convert_intwarper_mul(ctx)


    
@tensorrt_converter("torch2trt.converters.size.IntWarper.__sub__")
...
@tensorrt_converter("torch2trt.converters.size.IntWarper.__rsub__")
...
@tensorrt_converter("torch2trt.converters.size.IntWarper.__floordiv__")
...
@tensorrt_converter("torch2trt.converters.size.IntWarper.__rfloordiv__")
...
@tensorrt_converter("torch2trt.converters.size.IntWarper.__pow__")
...
@tensorrt_converter("torch2trt.converters.size.IntWarper.__rpow__")
